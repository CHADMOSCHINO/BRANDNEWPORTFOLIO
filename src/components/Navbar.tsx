    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 sm:h-20 flex items-center justify-between">
          {/* Logo */}
          <button onClick={goToTop} className="relative z-10 mix-blend-difference group" aria-label="CG CHAD, go to top">
          ...
          {/* Desktop right: availability + reserve CTA */}
          <div className="hidden lg:flex items-center gap-6">
            ...
            <a
              ...
              className="group relative flex items-center gap-3 overflow-hidden rounded-full border border-white/[0.12] bg-white/[0.07] pl-1.5 pr-5 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_10px_40px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-all duration-300 hover:border-white/[0.22] hover:bg-white/[0.12] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.18),0_0_28px_rgba(52,211,153,0.14)] cursor-pointer"
            >
              <span className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_30%_0%,rgba(255,255,255,0.16),transparent_55%)] opacity-80" />
              ...
              <div className="relative z-10 w-8 h-8 rounded-full overflow-hidden border border-white/15 shadow-[0_0_18px_rgba(52,211,153,0.12)] shrink-0">
                <Image
        ...
        >
          ...
          >
            ...
            <a
              ...
              className="relative flex items-center justify-center gap-3 w-full overflow-hidden rounded-full border border-white/[0.12] bg-white/[0.07] text-white py-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl hover:bg-white/[0.1] hover:border-white/[0.18] active:bg-white/10 transition-all duration-300"
            >
              <span className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_35%_0%,rgba(255,255,255,0.16),transparent_58%)]" />
